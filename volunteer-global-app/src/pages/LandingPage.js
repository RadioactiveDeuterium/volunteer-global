    ...
    <div className="h-screen flex flex-col items-center justify-center bg-purple-200">
      ...
      <div classNameName="flex flex-col sm:flex-row">
        ...
        <button
          ...
          className="px-4 py-2 m-4 border border-transparent text-lg leading-6 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:border-blue-700 active:bg-blue-700 center"
        >
          I'm an Organization
        </button>
      </div>
